...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .gambar-preview { margin-top: 8px; width: 80px; height: 80px; object-fit: cover; border-radius: 6px; }
    </style>
</head>
<body>
    <div class="navbar">
    ...
    <div class="container">
        <div class="card">
            <h1 style="color:#2b1d12; font-size:1.2rem; margin-bottom:4px;">Edit Menu</h1>
            ...
            <form method="POST" action="{{ route('admin.menu.update', $menu->id_menu) }}" enctype="multipart/form-data">
                ...
                <input type="number" name="harga" id="harga" value="{{ old('harga', $menu->harga) }}" min="0" required>
                ...
                <select name="id_kategori" id="id_kategori" required>
                    ...
                    @foreach ($kategoris as $kat)
                        <option value="{{ $kat->id_kategori }}" @selected(old('id_kategori', $menu->id_kategori) == $kat->id_kategori)>
                            {{ $kat->nama_kategori }}
                        </option>
                    @endforeach
                </select>
                ...
                @if ($menu->gambar)
                    <img src="{{ Storage::url($menu->gambar) }}" class="gambar-preview"><br>
                    <small style="color:#888;">Upload baru untuk mengganti gambar lama</small>
                @endif
                <input type="file" name="gambar" id="gambar" accept="image/*" style="margin-top:8px;">
